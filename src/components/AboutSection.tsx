      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 md:gap-12 items-center">
          ...
          <div className="lg:col-span-7 mt-6 md:mt-0">
            ...
            >
              <button className="relative cursor-pointer inline-block text-base sm:text-lg group">
                <span className="relative z-10 block px-4 py-2 sm:px-5 sm:py-3 overflow-hidden font-medium leading-tight text-orange-600 transition-colors duration-300 ease-out border-2 border-orange-600 rounded-lg group-hover:text-white">
